...
import Semester3Result from './Semester3Result';
import Semester4Result from './Semester4Result';
            ...
            <div>
              ...
              <div className="bg-white rounded shadow">
                <div className="p-6">
                  ...
                  {/* Component Viewer */}
                  {selectedSemester?.selectedSemesterData?.component ? (
                    <div className="w-full">
                      {selectedSemester?.selectedSemesterData?.component === 'semester3' && <Semester3Result />}
                      {selectedSemester?.selectedSemesterData?.component === 'semester4' && <Semester4Result />}
                    </div>
                  ) : (
                    <div className="text-center p-8 bg-gray-50 rounded">
                      <p className="text-gray-600 mb-4">No results available for this semester.</p>
