      ...
      <div style={resultContainerStyle}>
        ...
        <div style={tableContainerStyle}>
          <table style={tableStyle}>
            ...
            <tbody>
              <tr>
                <td style={tableCellStyle}>23CSE1011</td>
                <td style={courseCellStyle}>Economics for Engineers</td>
              ...
              <tr>
                <td style={tableCellStyle}>23CSE1007</td>
                <td style={courseCellStyle}>Processor Architecture and Interfacing</td>
              ...
              <tr>
                <td style={tableCellStyle}>23CSE2002</td>
                <td style={courseCellStyle}>Data Structures and Algorithms</td>
                <td style={tableCellStyle}>4</td>
                <td style={tableCellStyle}>P</td>
                <td style={tableCellStyle}>P</td>
                <td style={tableCellStyle}>B+</td>
              ...
              <tr>
                <td style={tableCellStyle}>23CSE2003</td>
                <td style={courseCellStyle}>Software Engineering</td>
              ...
              <tr>
                <td style={tableCellStyle}>23CSE2009</td>
                <td style={courseCellStyle}>Database Management Systems Lab</td>
              ...
              <tr>
                <td style={tableCellStyle}>23CSE2004</td>
                <td style={courseCellStyle}>Database Management Systems</td>
                <td style={tableCellStyle}>3</td>
                <td style={tableCellStyle}>P</td>
                <td style={tableCellStyle}>B</td>
                <td style={tableCellStyle}>B+</td>
              ...
              <tr>
                <td style={tableCellStyle}>23CSE1010</td>
                <td style={courseCellStyle}>Project Based Learning - I</td>
                <td style={tableCellStyle}>2</td>
                <td style={tableCellStyle}>P</td>
                <td style={tableCellStyle}>A</td>
                <td style={tableCellStyle}>A</td>
              ...
              <tr>
                <td style={tableCellStyle}>23MIE8001</td>
                <td style={courseCellStyle}>Entrepreneurship</td>
                <td style={tableCellStyle}>2</td>
                <td style={tableCellStyle}>P</td>
                <td style={tableCellStyle}>A</td>
                <td style={tableCellStyle}>A</td>
              ...
              <tr>
                <td style={tableCellStyle}>23CSE2007</td>
                <td style={courseCellStyle}>Java Programming</td>
                <td style={tableCellStyle}>3</td>
                <td style={tableCellStyle}>P</td>
                <td style={tableCellStyle}>B</td>
                <td style={tableCellStyle}>B+</td>
              ...
              <tr>
                <td style={tableCellStyle}>23SHD1007</td>
                <td style={courseCellStyle}>Societal Immersion, Spirituality and Morality - I</td>
                <td style={tableCellStyle}>-</td>
                <td style={tableCellStyle}>P</td>
                <td style={tableCellStyle}>B</td>
                <td style={tableCellStyle}>A</td>
        ...
        <div style={summaryStyle}>
          Credits Completed: 22 | Credits Registered: 22 | SGPA: 7.00
        </div>

        <div style={cumulativeStyle}>
          <p style={{ margin: "4px 0", fontWeight: "bold" }}>Cumulative Record</p>
          <p style={{ margin: "2px 0" }}>Credits Completed: 66</p>
          <p style={{ margin: "2px 0" }}>Credits Registered: 66</p>
          <p style={{ margin: "2px 0" }}>CGPA: 7.00</p>
        </div>
        ...
        <div style={footerStyle}>
          ...
          <div style={signatureStyle}>
            <span>Date: 16 January 2025</span>
